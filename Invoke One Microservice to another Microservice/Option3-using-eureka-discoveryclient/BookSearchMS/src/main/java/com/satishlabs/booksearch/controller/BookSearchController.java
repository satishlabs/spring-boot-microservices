...
public class BookSearchController {
	...
	public BookInfo getBookById(@PathVariable Integer bookId) {
		...
		// Option-3: Using Eureka and DicoveryClient

		// Invoke BookPrice with DiscoveryClient
		List<ServiceInstance> instanceList = discoveryClient.getInstances("BookPriceMS");
		for (ServiceInstance instance : instanceList) {
			System.out.println("hello : " + instance);
		}

		String baseURL = instanceList.get(0).getUri().toString();
